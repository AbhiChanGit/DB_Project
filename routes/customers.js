    ...
    try {
        ...
        if (status === 'processing') {
            const deliveryPlan = await db.query(
                "INSERT INTO delivery_plans (order_id, delivery_type, delivery_price, ship_date, delivery_date, tracking_number) VALUES ($1, $2, $3, NOW(), NOW() + INTERVAL '3 days', $4) RETURNING delivery_plan_id",
